...
--
-- Host: localhost
-- Generation Time: May 06, 2025 at 05:46 PM
...
(7, 1, 26, 3, 'Ihan ok', '2025-04-29 11:17:16'),
(8, 1, 26, 3, 'Ihan ok', '2025-04-29 11:17:43'),
(9, 1, 36, 5, 'Mahdottoman herkullista', '2025-04-29 11:21:10'),
(10, 1, 26, 4, 'Erittäin hyvää', '2025-04-29 11:28:27'),
(11, 1, 36, 5, 'Todella hyvää ja ammattimaista palvelua', '2025-04-29 13:10:29'),
(12, 1, 26, 2, 'Ei mitenkään erityistä', '2025-04-29 13:33:57'),
...
(5, 3, 3, 'Ihan ok...', '2025-05-05 18:09:08');
...
--
ALTER TABLE `menu`
  MODIFY `pizza_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
...
--
ALTER TABLE `order_item_reviews`
  MODIFY `item_review_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT for table `restaurant_reviews`
--
ALTER TABLE `restaurant_reviews`
  MODIFY `restaurant_review_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
